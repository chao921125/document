...
| [绘画](https://www.cutout.pro/)                                                  |

# 文本
|                                                                           |
|---------------------------------------------------------------------------|
| [llamav2](https://huggingface.co/spaces/ysharma/Explore_llamav2_with_TGI) |
| [Gradio](https://huggingface.co/spaces/ysharma/ChatGPT-Plugins-in-Gradio) |
| [开源模型](https://huggingface.co/spaces/lmsys/chatbot-arena)                 |
...
|                                                        |
|--------------------------------------------------------|
| [视频](https://huggingface.co/spaces/hysts/zeroscope-v2) |
...
| [接入微信](https://github.com/zhayujie/chatgpt-on-wechat)    |
| [接入微信](https://github.com/opentdp/wrest-chat)            |
| [聚合](https://quillbot.com/)                              |
